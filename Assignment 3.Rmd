...
statTestResults$ConditionCCP <- c("p-value"=summaryConditionCCP$p.value, "p-adj"=p.adjust(summaryConditionCCP$p.value, n=6))
...
statTestResults$PAMCCP <- c("p-value"=summaryPAMCCP$p.value, "p-adj"=p.adjust(summaryPAMCCP$p.value, n=6))
summaryKMeansCCP <- chisq.test(table(chiSqData$KMeans, chiSqData$CCP))
statTestResults$KMeansCCP <- c("p-value"=summaryKMeansCCP$p.value, "p-adj"=p.adjust(summaryKMeansCCP$p.value, n=6))
