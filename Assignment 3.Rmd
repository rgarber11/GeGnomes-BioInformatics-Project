...
l = list(clustInfo, tenClust, hunClust, onekClust, fivekClust, tenkClust)
...
ggplot(clustInfo,
  ...
  geom_stratum(width = 1/4, fill = "blue", color = "grey") +
  geom_label(stat = "stratum", aes(label = after_stat(stratum),)) +
  scale_x_discrete(limits = c("samples", "ten"), expand = c(.05, .05)) +
